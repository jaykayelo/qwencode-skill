...
WriteS "init" "Starting..."         2
WriteS "check" "Checking deps..."     8
if (-not (Get-Command qwen -ErrorAction SilentlyContinue)) {
    WriteS "error" "Qwen Code not found" 100
    throw "Install: npm install -g @qwen-code/qwen-code"
}

WriteS "connect" "Connecting Ollama..." 15
$tmp = ollama list 2>&1
if ($LASTEXITCODE -ne 0) {
    WriteS "connect" "Starting Ollama..." 18
    Start-Process ollama -ArgumentList "serve" -WindowStyle Hidden
    Start-Sleep -Seconds 3
}

WriteS "model" "Model: $Model"        22
WriteS "running" "Qwen Code running..."  30
